    ...
    <v-flex xs12 sm8 md6>
      ...
      <v-card>
        ...
        <v-card-text>
          ...
          For more information on Vuetify, check out the <a href="https://vuetifyjs.com" target="_blank">documentation</a>.</p>
          <p>If you have questions, please join the official <a href="https://chat.vuetifyjs.com/" target="_blank" title="chat">discord</a>.
      ...
      <v-card>
        <v-card-title class="headline">Hello, I am a Vue/Nuxt/Vuetify Museum POC app!</v-card-title>
      </v-card>
    </v-flex>
  </v-layout>
</template>
